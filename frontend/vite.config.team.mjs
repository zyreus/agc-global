/**
 * Vite config with Team Section auto-injection (no source file edits required).
 * Used by PM2 and build-with-team script.
 */
...
const { agcSiteRestructurePlugin } = require('../scripts/vite-plugin-inject-team-section.cjs')
...
const baseConfig = defineConfig({
  base: './',
  plugins: [react(), agcSiteRestructurePlugin()],
  resolve: {
